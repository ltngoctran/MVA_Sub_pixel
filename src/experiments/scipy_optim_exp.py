...
from ..lib.registrations.scipy_optim_registration import scipy_registration_method
...
for i in range(n_param):
    ...
    t_hat    = scipy_registration_method(u0,u1)
    t_hat_ts = scipy_registration_method(w0_ts,w1_ts)
    t_hat_ls = scipy_registration_method(w0_ls,w1_ls)
    t_hat_ns = scipy_registration_method(w0_ns,w1_ns)
...
plt.savefig(results_dir+'error_scipy_registration_method.png')